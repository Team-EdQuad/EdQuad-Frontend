            ...
            <Table>
                ...
                sx={{
                  backgroundColor:
                    theme.palette.mode === 'dark'
                      ? theme.palette.primary.dark // Dark mode header background
                      : theme.palette.primary.main, // Light mode header background
              ...
              <TableBody>
                ...
                <TableRow>
                  <TableCell
                    sx={{
                      backgroundColor: theme.palette.success.light, // Dynamic total row background
                      fontWeight: 'bold',
                    }}
                  >
                    Total
                  ...
                  <TableCell
                    sx={{
                      backgroundColor: theme.palette.success.lighter, // Dynamic total cell background
                    }}
                  >
                    {term1Total}
                  </TableCell>
                ...
                <TableRow>
                  <TableCell
                    sx={{
                      backgroundColor: theme.palette.success.light, // Dynamic average row background
                      fontWeight: 'bold',
                    }}
                  >
                    Average
                  ...
                  <TableCell
                    sx={{
                      backgroundColor: theme.palette.success.lighter, // Dynamic average cell background
                    }}
                  >
                    {term1Avg.toFixed(2)}
                  </TableCell>
